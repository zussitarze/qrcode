...
;; Encodes message with num-parity bytes.
;; Parity check symbols are formed by X^p * u(x) mod g(x), where p = num-parity.
;; Since g(x) is monic, we can take the leading coefficient of each dividend
;; as the next quotient term. 
